...
class Business : Fragment() {
    ...
    private fun getNews() {
        val news: Call<News> = NewsService.newsInstance.getHeadlines("in",pageNum, "business")
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_business, container, false)

        adapter = NewsAdapter(requireContext(), articles)
        v.businessList.adapter = adapter
        ...
        v.businessList.layoutManager = LinearLayoutManager(requireContext())
        getNews()
