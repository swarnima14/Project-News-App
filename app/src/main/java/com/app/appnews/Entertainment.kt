...
class Entertainment : Fragment() {
    ...
    override fun onCreateView(
        ...
        v.entertainmentList.adapter = adapter
        ...
        v.entertainmentList.layoutManager = LinearLayoutManager(requireContext())
        getNews()
    ...
    private fun getNews() {
        val news: Call<News> = NewsService.newsInstance.getHeadlines("in",pageNum, "entertainment")
