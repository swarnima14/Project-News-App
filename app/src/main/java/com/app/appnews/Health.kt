...
class Health : Fragment() {
    ...
    override fun onCreateView(
        ...
        v.healthList.layoutManager = LinearLayoutManager(requireContext())
        getNews()
    ...
    private fun getNews() {
        val news: Call<News> = NewsService.newsInstance.getHeadlines("in",pageNum, "health")
