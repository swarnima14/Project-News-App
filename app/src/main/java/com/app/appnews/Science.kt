...
class Science : Fragment() {
    ...
    override fun onCreateView(
        ...
        layoutManager.setItemChangedListener(object : StackLayoutManager.ItemChangedListener {
            override fun onItemChanged(position: Int) {
                ...
                // conScience!!.setBackgroundColor(Color.parseColor(ColorPicker.getColor()))
        ...
        v.scienceList.layoutManager = LinearLayoutManager(requireContext())
        getNews()
    ...
    private fun getNews() {
        val news: Call<News> = NewsService.newsInstance.getHeadlines("in",pageNum, "science")
